...
def main(args):
    ...
    if args.opt == 'sgd':
        ...
        optimizer = torch.optim.NAdam(params, lr=args.lr, weight_decay=args.weight_decay)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        time.sleep(2)
        results = evaluate.evaluate(model, val_loaders, args.data_cats, logger)
